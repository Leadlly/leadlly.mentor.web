        ...
        <div className="h-40 overflow-y-auto custom__scrollbar p-2 lg:px-4">
          <ul className="flex flex-col justify-start gap-y-3">
            {chapterData.topics.map((topic) => (
              <li
                key={topic.title}
                className="text-xs md:text-lg lg:text-xl leading-tight font-normal md:mb-0 mb-[7px] flex md:items-center md:gap-x-3 md:flex-row flex-col gap-y-3">
                <p className="md:w-56 lg:w-96">
