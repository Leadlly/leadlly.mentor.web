...
export default function ErrorList() {
  return (
    <Tabs defaultValue="Maths" className="w-full">
      ...
      <TabsContent value="Maths" className="overflow-y-auto custom__scrollbar h-[calc(100dvh-120px)]">
      ...
      <TabsContent value="Physics" className="overflow-y-auto custom__scrollbar h-[calc(100dvh-120px)]">
      ...
      <TabsContent value="Chemistry" className="overflow-y-auto custom__scrollbar h-[calc(100dvh-120px)]">
