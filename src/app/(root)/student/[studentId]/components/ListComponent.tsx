...
const Popup: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <>
      <div className="absolute top-[50%] md:left-[15%] lg:left-[8%] transform -translate-y-1/2 w-[30%] xl:w-[415px] bg-white border border-gray-200 shadow-lg rounded-lg z-40 overflow-auto custom__scrollbar">
