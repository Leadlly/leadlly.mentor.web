...
import { FormField, FormControl, FormItem, FormMessage, Form } from '@/components/ui/form';
...
const ChatContent = ({ selectedStudent, chatData }: ChatContentProps) => {
