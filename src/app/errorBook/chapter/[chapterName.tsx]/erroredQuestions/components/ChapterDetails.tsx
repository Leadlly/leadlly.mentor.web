...
const ChapterDetails = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row justify-center items-center px-20 w-full  max-md:gap-5">
        <div className="flex justify-center items-center">
          <div className="flex flex-col justify-center items-center gap-2">
            ...
            <div className="flex flex-row pb-3 w-full justify-around text-gray-600 gap-2 md:gap-10">
