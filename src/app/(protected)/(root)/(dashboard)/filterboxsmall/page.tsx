  ...
  return (
    <div className="flex flex-col justify-between min-h-[calc(100dvh-140px)] px-4 py-5 ml-[28px] min-w-[200px] text-2xl">
      ...
      <div className="flex items-center gap-8 text-[#7D7D7D] mt-auto">
        <Link
          href="/"
          className="bg-[#F1E8FF] rounding-[4px] shadow-md text-[14px] font-medium px-[30px] py-[10px]"
        >
          Show Changes
        </Link>
        <button className="bg-[#E2D0FF] rounding-[4px] shadow-md text-[14px] font-medium px-[30px] py-[10px]">
          Clear Changes
        </button>
      </div>
    </div>
